  ...
  <Dialog v-model:open="isOpen">
    <DialogContent class="max-w-2xl">
      <DialogHeader>
        ...
        <DialogDescription>
          Share this class with other students using the link, class code, or QR code
        </DialogDescription>
      </DialogHeader>
        ...
        <TabsContent value="link" class="space-y-4 mt-4">
          <div class="space-y-2">
            ...
            <p class="text-xs text-muted-foreground">
              Share this link with other students to join this class
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="qr" class="space-y-4 mt-4">
          <div class="space-y-4">
            ...
            <p class="text-xs text-muted-foreground text-center">
              Students can scan this QR code with their phone to join this class
            </p>
          </div>
        </TabsContent>
      </Tabs>
