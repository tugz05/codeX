...
import { Loader2, Save, ArrowLeft, FileText, X, UploadCloud, Trash2 } from 'lucide-vue-next'
...
const form = useForm({
  ...
  instruction: props.assignment.instruction ?? '',
  points: props.assignment.points ?? null,
  due_date: props.assignment.due_date ?? null,
  due_time: props.assignment.due_time ?? null,
  accessible_date: props.assignment.accessible_date ?? null,
  accessible_time: props.assignment.accessible_time ?? null,
  attachments: [] as File[],
  attachments_remove: [] as number[],
})

const accessToggle = ref(!!props.assignment.accessible_date)
const fileInputRef = ref<HTMLInputElement | null>(null)
const selectedFiles = ref<File[]>([])
const isDragging = ref(false)
const existingAttachments = ref(props.assignment.attachments)
...
function submit() {
  form.put(route('instructor.assignments.update', [props.classlist.id, props.assignment.id]), {
    forceFormData: true,
    onSuccess: () => {
    ...
    <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4 md:p-6">
      ...
      <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-2xl md:text-3xl font-bold tracking-tight">Edit Assignment</h1>
      ...
      <div class="flex-1">
        <Card class="border-2 shadow-sm">
          <CardHeader class="pb-4">
            ...
            <CardDescription>Update the assignment information</CardDescription>
          </CardHeader>
                ...
                <div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div v-if="existingAttachments.length > 0" class="space-y-3">
                      <p class="text-sm font-medium text-foreground">Current Attachments</p>
                      <div class="space-y-2">
                        <div
                    ...
                    <div class="space-y-4">
                      ...
                      <div v-if="selectedFiles.length > 0" class="space-y-3">
                        <p class="text-sm font-medium text-foreground">New Files ({{ selectedFiles.length }})</p>
                        <div class="space-y-2">
                          <div
