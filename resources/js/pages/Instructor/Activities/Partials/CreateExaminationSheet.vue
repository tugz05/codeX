      ...
      <div class="flex h-full flex-col">
        <div class="px-6 pt-6">
          <SheetHeader class="text-left">
            <SheetTitle>Create Examination</SheetTitle>
            <SheetDescription>Create a formal examination with questions. Typically more restrictive than quizzes.</SheetDescription>
          </SheetHeader>
        </div>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between rounded-lg border p-4">
                <div>
                  ...
                  <p class="text-xs text-muted-foreground">Display correct answers after submission (usually disabled for exams)</p>
                </div>
              ...
              <div class="flex items-center justify-between rounded-lg border p-4">
                <div>
                  ...
                  <p class="text-xs text-muted-foreground">Mark this examination as requiring supervision</p>
                </div>
              ...
              <div class="flex items-center justify-between rounded-lg border p-4">
                <div>
                  ...
                  <p class="text-xs text-muted-foreground">Make examination available to students</p>
                </div>
            ...
            <div class="space-y-4">
              ...
              <div v-for="(question, qIndex) in questions" :key="qIndex" class="rounded-lg border p-4 space-y-4">
                ...
                <div v-if="question.type === 'multiple_choice'" class="space-y-2">
                  ...
                  <div v-for="(option, oIndex) in question.options" :key="oIndex" class="flex items-center gap-2">
                    <RadioGroup v-model="question.correct_answer" class="flex items-center">
                    ...
                    <Input
                      ...
                      @input="updateQuestionOption(qIndex, oIndex, ($event.target as HTMLInputElement).value)"
                    />
                    <Button
              ...
              <Alert v-if="questions.length === 0" variant="default">
                <AlertDescription>Add at least one question to create the examination.</AlertDescription>
              </Alert>
            </div>
          </form>
        </div>
