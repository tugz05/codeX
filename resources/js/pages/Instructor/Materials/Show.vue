...
import { ArrowLeft, Edit, Download, Calendar, User, ExternalLink, Video, BookOpen, FileText, Clock } from 'lucide-vue-next'
      ...
      <header class="sticky top-0 z-30 w-full border-b bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div class="mx-auto flex w-full max-w-[1600px] items-center justify-between px-4 py-3 md:py-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <Link :href="route('instructor.materials.edit', [classlist.id, material.id])">
              <Button>
          ...
          <aside class="md:col-span-4">
            <div class="space-y-4">
              ...
              <Card class="border-2">
                ...
                <CardContent>
                  <div class="space-y-2">
                    <Link :href="route('instructor.materials.edit', [classlist.id, material.id])" class="block">
