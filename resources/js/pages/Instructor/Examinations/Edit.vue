...
const form = useForm({
  ...
  description: props.examination.description || '',
  time_limit: props.examination.time_limit,
  attempts_allowed: props.examination.attempts_allowed,
  shuffle_questions: props.examination.shuffle_questions,
  show_correct_answers: props.examination.show_correct_answers,
  is_published: props.examination.is_published,
  require_proctoring: props.examination.require_proctoring,
  start_date: props.examination.start_date,
  end_date: props.examination.end_date,
  tests: [] as Test[],
})
...
onMounted(() => {
  // Load existing tests
  tests.value = props.examination.tests.map(test => ({
    title: test.title,
    type: test.type || '',
    ...
    questions: test.questions.map(q => ({
      ...
      type: q.type,
      points: q.points,
      options: q.options && q.options.length > 0 ? q.options : (q.type === 'multiple_choice' ? ['', '', '', ''] : []),
...
function addTest() {
  ...
  tests.value.push({
    ...
    questions: [{
      question_text: '',
      type: getQuestionTypeFromTestType(defaultType),
      points: 1,
...
function submit() {
  ...
  form.put(route('instructor.examinations.update', [props.classlist.id, props.examination.id]), {
    onSuccess: () => {
      toast.success('Examination updated successfully.')
      router.visit(route('instructor.activities.index', props.classlist.id))
    },
    onError: () => toast.error('Unable to update examination.'),
    ...
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-xl font-semibold">Edit Examination</h1>
      ...
      <!-- Same template as Create.vue but with Edit title -->
      <!-- Copy the rest of the template from Create.vue -->
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <!-- Main Content - Same as Create.vue -->
        <div class="lg:col-span-2 space-y-6">
          ...
          <!-- Tests Section - Same structure as Create.vue -->
          <Card>
            <CardHeader>
              <div class="flex items-center justify-between">
                <div>
        ...
        <!-- Sidebar Settings - Same as Create.vue -->
        <div class="space-y-6">
          <Card>
            <CardHeader>
