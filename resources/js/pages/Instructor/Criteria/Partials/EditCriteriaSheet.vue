...
const props = defineProps<{
  ...
  criteria: {
    ...
    items:Array<{ id:number; label:string; description:string|null; points:number|null; weight:number|null; sort_order:number }>
  }
}>()
...
const form = useForm({
  ...
  grading_method: props.criteria.grading_method,
  items: props.criteria.items.map(i => ({ ...i })) as Item[],
})
...
function submit() {
  form.put(route('instructor.criteria.update', props.criteria.id), {
    onSuccess: () => { toast.success('Criteria updated.'); emit('update:open', false); emit('closed') },
      ...
      <div class="flex h-full flex-col">
        <div class="px-6 pt-6">
          <SheetHeader class="text-left">
            ...
            <SheetDescription>Update rubric definition.</SheetDescription>
          </SheetHeader>
        </div>
          ...
          <form @submit.prevent="submit" class="mt-4 space-y-5">
            ...
            <div class="grid gap-4 sm:grid-cols-3">
              ...
              <!-- <div class="space-y-2 sm:col-span-2">
                ...
                <Input id="total_points" type="number" min="1" v-model.number="form.total_points" />
              </div> -->
            </div>
                ...
                <div v-for="(it, idx) in form.items" :key="idx" class="rounded-lg border p-3">
                  <div class="grid gap-3 sm:grid-cols-12">
                    ...
                    <div class="sm:col-span-2 flex items-end justify-end">
                      <Button variant="outline" size="icon" @click.prevent="removeItem(idx)">
                  ...
                  <div class="mt-2">
                    ...
                    <Textarea v-model="it.description" rows="2" />
                  </div>
                </div>
              </div>
