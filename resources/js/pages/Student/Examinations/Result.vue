...
import { ArrowLeft, Award, CheckCircle2, XCircle, FileText, Clock, Calendar, TrendingUp, AlertCircle } from 'lucide-vue-next'
...
<template>
  <Head :title="`Examination Results: ${props.examination.title}`" />
  ...
  <AuthLayoutStudent>
    <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4 md:p-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
          <h1 class="text-2xl font-bold tracking-tight">Examination Results</h1>
          <p class="text-sm text-muted-foreground mt-1">{{ props.examination.title }}</p>
        </div>
      </div>
      ...
      <Card class="border-2">
        <CardHeader class="border-b">
          ...
          <CardDescription>
            <span v-if="totalViolations > 0">The following activities were detected and logged during your examination attempt.</span>
            <span v-else>No violations were detected during your examination attempt. All activities were normal.</span>
          </CardDescription>
        </CardHeader>
        <CardContent>
          <!-- Violation Statistics -->
          ...
          <div v-if="totalViolations === 0" class="text-center py-8">
            ...
            <p class="text-sm text-muted-foreground">Your examination attempt was completed without any suspicious activities.</p>
          </div>
                  ...
                  <div class="border-2 p-5">
                    ...
                    <div v-if="answer.question_type === 'true_false'" class="space-y-3">
                      <div class="flex items-center gap-4">
                        ...
                        <div v-if="props.examination.show_correct_answers" class="flex-1">
                    ...
                    <div v-if="answer.question_type === 'short_answer' || answer.question_type === 'essay'" class="space-y-3">
                      ...
                      <div v-if="props.examination.show_correct_answers">
                        <p class="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2">Correct Answer</p>
                        <div class="border-2 p-4">
                          <p class="text-sm whitespace-pre-wrap">
                    ...
                    <!-- Explanation -->
                    <div
                      v-if="answer.explanation && props.examination.show_correct_answers"
